...
export default function RegisterAdmin() {
    ...
    const handleRegisterAdmin = (event) => {
        ...
        //     return alert("Password Anda salah. Silahkan perbaiki.")
        // }
            ...
            <div className='flex justify-center items-center min-h-screen flex-col'>
                ...
                <div className='justify-center items-center w-[711px] h-[560px] px-11 shadow-[0_3px_5px_5px_rgba(0,0,0,0.2)] '>
                    <form onSubmit={handleRegisterAdmin} className="max-w-md mx-auto translate[-50%] top-[15%] relative">
                        <p className='mb-5 text-[32px] font-medium'>Register Admin</p>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <div className='flex gap-8'>
                                ...
                                <div className="relative z-0 w-full mb-5 group">
                                    <input type="password" name="confirmPassword" id="confirmPassword" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <div className="relative z-0 w-full mb-8 group">
                                <input type="text" name="token" id="token" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "  required />
                                <label className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Token</label>
                            </div>
