...
export default function PendaftaranPoli() {
    ...
    const userRegister = (event) => {
        ...
        const biaya = parseInt(event.target.biaya.value);
        ...
        axios.post(`/medicalRecord/pendaftaran/${id}`, requestingData).then((result) => {
            console.log(result);
                ...
                <div className='flex justify-center items-center min-h-screen flex-col p-12'>
                    ...
                    <div className='w-[511px] px-11 p-8 mt-[40px] shadow-[0_3px_5px_5px_rgba(0,0,0,0.2)] '>
                        <form className="max-w-md mx-auto translate[-50%] top-[20%] relative" onSubmit={userRegister}>
                            ...
                            <button type="submit" className="text-white bg-[#388E3C] focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center mx-auto block">Daftar</button>
                        </form>
                    </div>
                </div>
            </section>
