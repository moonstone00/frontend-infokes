...
export default function RegistrasiDokter() {
    ...
    useEffect(() => {
        axios.get("/poli").then((result) => {
            console.log(result.data.poli)
            setPoli(result.data.poli)
        })
    }, [])
    ...
    const handleRegisterAdmin = (event) => {
        ...
        const poli_id = event.target.poli.value
        const spesialisasi = event.target.spesialisasi.value
        ...
        axios.post("/registration/dokter", requestingData).then((result) => {
            console.log(result);
            ...
            <div className='flex flex-col justify-center items-center min-h-screen my-12'>
                ...
                <div className='justify-center items-center w-[711px] h-[730px] px-11 shadow-[0_3px_5px_5px_rgba(0,0,0,0.2)] '>
                    <form onSubmit={handleRegisterAdmin} className="max-w-md mx-auto translate[-50%] top-[15%] relative">
                        <p className='mb-5 text-[32px] font-medium'>Registeasi Dokter</p>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <select required id="poli" name="poli" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg mb-8 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500">
